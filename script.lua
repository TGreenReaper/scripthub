...
TextLabel.Position = UDim2.new(0.209188655, 0, 0.136655942, 0)
...
local function XCTRVF_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(XCTRVF_fake_script)()
local function GKEP_fake_script() -- Blox.LocalScript 
...
coroutine.wrap(GKEP_fake_script)()
local function KNPR_fake_script() -- TextLabel.LocalScript 
...
coroutine.wrap(KNPR_fake_script)()
local function MNEBIU_fake_script() -- TextLabel.LocalScript 
	local script = Instance.new('LocalScript', TextLabel)
...
coroutine.wrap(MNEBIU_fake_script)()
